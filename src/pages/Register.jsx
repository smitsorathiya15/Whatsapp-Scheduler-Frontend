...
import { authAPI, unwrapError } from '../api'
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.brandBox}>
          ...
          <h2 style={styles.title}>Join Whatsapp Scheduler</h2>
...
const styles = {
  ...
  brandBox: { textAlign: 'center', marginBottom: '32px' },
